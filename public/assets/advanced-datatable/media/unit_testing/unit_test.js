...
var oTest = {
	...
	/*
	 * Function: fnStart
	 * Purpose:  Indicate that this is a new unit and what it is testing (message to end users)
	 * Returns:  -
	 * Inputs:   string:sMessage - message to give to the users about this unit
	 */
